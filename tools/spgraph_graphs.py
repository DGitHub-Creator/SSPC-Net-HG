...
def compute_sp_graph(xyz, d_max, in_component, components, labels, n_labels):
    ...
    # scipy >= 1.0 exposes tetrahedra as ``simplices``; old SPGraph used
    # the removed ``vertices`` alias.
    tetrahedra = tri.simplices
    interface = in_component[tetrahedra[:, 0]] != in_component[tetrahedra[:, 1]]
    edg1 = np.vstack((tetrahedra[interface, 0], tetrahedra[interface, 1]))
    edg1r = np.vstack((tetrahedra[interface, 1], tetrahedra[interface, 0]))
    interface = in_component[tetrahedra[:, 0]] != in_component[tetrahedra[:, 2]]
    edg2 = np.vstack((tetrahedra[interface, 0], tetrahedra[interface, 2]))
    edg2r = np.vstack((tetrahedra[interface, 2], tetrahedra[interface, 0]))
    interface = in_component[tetrahedra[:, 0]] != in_component[tetrahedra[:, 3]]
    edg3 = np.vstack((tetrahedra[interface, 0], tetrahedra[interface, 3]))
    edg3r = np.vstack((tetrahedra[interface, 3], tetrahedra[interface, 0]))
    interface = in_component[tetrahedra[:, 1]] != in_component[tetrahedra[:, 2]]
    edg4 = np.vstack((tetrahedra[interface, 1], tetrahedra[interface, 2]))
    edg4r = np.vstack((tetrahedra[interface, 2], tetrahedra[interface, 1]))
    interface = in_component[tetrahedra[:, 1]] != in_component[tetrahedra[:, 3]]
    edg5 = np.vstack((tetrahedra[interface, 1], tetrahedra[interface, 3]))
    edg5r = np.vstack((tetrahedra[interface, 3], tetrahedra[interface, 1]))
    interface = in_component[tetrahedra[:, 2]] != in_component[tetrahedra[:, 3]]
    edg6 = np.vstack((tetrahedra[interface, 2], tetrahedra[interface, 3]))
    edg6r = np.vstack((tetrahedra[interface, 3], tetrahedra[interface, 2]))
    del tri, interface
